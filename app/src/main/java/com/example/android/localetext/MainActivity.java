...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final String myFormatedDate= DateFormat.getInstance().format(myDate);
        TextView expDateView= findViewById(R.id.date);
        expDateView.setText(myFormatedDate);

        String myFormatedPrice;
        String deviceLocale= Locale.getDefault().getCountry();
        if(deviceLocale.equals("ID")){
            mPrice*=mIDExchangeRate;
            myFormatedPrice=mCurrencyFormat.format(mPrice);
        }else{
            mCurrencyFormat=NumberFormat.getCurrencyInstance(Locale.US);
            myFormatedPrice=mCurrencyFormat.format(mPrice);
        }
        TextView localePrice= findViewById(R.id.price);
        localePrice.setText(myFormatedPrice);
                ...
                if (actionId == EditorInfo.IME_ACTION_DONE) {
                    ...
                    if (v.toString().equals("")) {
                        ...
                        try {
                            ...
                            String myFormatedTotalPrice = mCurrencyFormat.format(total);
                            totalPrice.setText(myFormatedTotalPrice);
